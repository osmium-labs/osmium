...
official/supported Docker Images found at https://hub.docker.com/r/osmium-labs/osmiumd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/osmium-labs/osmiumd-develop/ when changing the above text**