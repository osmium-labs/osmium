...
This directory contains the files necessary to perform bootstrappable Osmium
Core builds.
...
To build Osmium Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Osmium Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/osmium-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/osmium-labs/guix.sigs).
...
[guix-docker]: https://github.com/osmium-labs/osmium/tree/master/contrib/guix/Dockerfile
