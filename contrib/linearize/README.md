# Linearize
Construct a linear, no-fork, best version of the Osmium blockchain.
...
JSON-RPC server. Running `osmiumd` or `osmium-qt -server` will be sufficient.
...
* `input`: osmiumd blocks/ directory containing blkNNNNN.dat
