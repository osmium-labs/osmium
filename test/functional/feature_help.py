...
"""Verify that starting osmiumd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start osmiumd with -h for help text")
        ...
        self.log.info("Start osmiumd with -version for version information")
        ...
        self.log.info("Start osmiumdd with -fakearg to make sure it does not start")
