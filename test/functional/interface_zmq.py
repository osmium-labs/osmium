...
from test_framework.messages import osmiumhash, hash256
...
def osmiumhash_reversed(byte_str):
    return osmiumhash(byte_str)[::-1]
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], osmiumhash_reversed(block[:80]).hex())
