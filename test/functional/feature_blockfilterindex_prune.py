...
class FeatureBlockfilterindexPruneTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # 365, not Dash's 366: Osmium's coinbase carries an extra devfee output, so blocks are
        # slightly larger and the block-file boundary that pruning stops at falls one earlier.
        assert_equal(pruneheight, 365)
