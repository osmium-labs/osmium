...
def get_label(pr_num):
    return requests.get(f'https://api.github.com/repos/osmium-labs/osmium/pulls/{pr_num}').json()['head']['label']
...
def main():
    ...
    for conflict in conflictPrs:
        ...
        r = requests.get(f'https://api.github.com/repos/osmium-labs/osmium/pulls/{this_pr_num}')
        ...
        r = requests.get(f'https://github.com/osmium-labs/osmium/branches/pre_mergeable/{our_pr_label}...{get_label(this_pr_num)}')
