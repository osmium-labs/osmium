# Support for Output Descriptors in Osmium Core

Since Osmium Core v0.17, there is support for Output Descriptors. This is a
...
existing Osmium Core wallets, a convenience function `combo` is
...
All RPCs in Osmium Core will include the checksum in their output. Only
