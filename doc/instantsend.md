...
This mechanism has been integrated into Bitcore-Node-Osmium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/osmium-labs/insight-api-osmium#web-socket-api](https://github.com/osmium-labs/insight-api-osmium#web-socket-api)
* API: [https://github.com/osmium-labs/insight-api-osmium#instantsend-transactions](https://github.com/osmium-labs/insight-api-osmium#instantsend-transactions)
