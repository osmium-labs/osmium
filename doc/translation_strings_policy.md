...
This document provides guidelines for internationalization of the Osmium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `osmium_en.ts` remains unchanged.
