 ...
 *  We have 4 times smaller block times in Osmium, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Osmium Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // OSMIUM this code also handles non-TXs (Osmium specific messages)
