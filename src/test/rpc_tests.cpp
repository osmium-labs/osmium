...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    r = CallRPC(std::string("createrawtransaction ")+prevout+" "+
      "{\"MRZ7mUGtMhZBHbdHcNzeri1wwHW6XpiiRD\":11}");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("2249999.9999999")), 224999999999990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("2249999.99999999")), 224999999999999LL);
